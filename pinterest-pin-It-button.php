...
function wl_pinit_js()
{
	...
	if (wp_is_mobile() && $PinItStatus == 0) {
		...
		?>
		<script type="text/javascript" async defer data-pin-color="<?php echo esc_attr($PinItColor); ?>" <?php
		   if ($PinItSize == 'large') {
			   ?> data-pin-height="28" <?php } ?> data-pin-hover="false"
			src="<?php echo esc_url(WEBLIZAR_PINIT_PLUGIN_URL . 'js/pinit.js'); ?>">
			</script>
		<?php
	}
	global $wp;
	...
	if (is_array($all_exclude_pages) && count($all_exclude_pages) > 0 && in_array($current_page, $all_exclude_pages)) {
		?>
		<script type="text/javascript" async defer data-pin-color="<?php echo esc_html($PinItColor); ?>" <?php
		   if ($PinItSize == 'large') {
			   ?> data-pin-height="28" <?php } ?> data-pin-hover="false"
			src="<?php echo esc_url(WEBLIZAR_PINIT_PLUGIN_URL . 'js/pinit.js'); ?>">
			</script>
		...
		<script type="text/javascript" async defer data-pin-color="<?php echo esc_html($PinItColor); ?>" <?php
		   if ($PinItSize == 'large') {
			   ?> data-pin-height="28" <?php } ?> data-pin-hover="<?php echo esc_html($PinItOnHover); ?>"
			src="<?php echo esc_url(WEBLIZAR_PINIT_PLUGIN_URL . 'js/pinit.js'); ?>"></script>
		<?php
	}
